...
export default defineUserConfig({
  ...
  theme: FileList([
    {
      // 挂载路径
      //mountPath: "/KnapsackToGo4下载",我注释的
      // 文件解析器，这里使用githubReleasesFilesAnalysis,可以解析github的release文件
      //analysis: githubReleasesFilesAnalysis({我注释的
        // 仓库所有者的用户名
       // user: "jianjianai",我注释的
        // 仓库所有者的仓库名
       // repository: "KnapsackToGo4"我注释的
      }),
    },
    {
    //  mountPath: "/",我注释的
     // analysis: githubReleasesFilesAnalysis({ user: "jianjianai", repository: "FList" }),我注释的
